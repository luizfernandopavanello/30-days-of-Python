...
To create a module we write our codes in a python script and we save it as a .py file. Create a file named _mymodule.py_ inside your project folder. Let us write some code in this file.
...
# main.py file
import mymodule
print(mymodule.generate_full_name('Case', 'Sprawl')) # Case Sprawl
```
...
print(generate_full_name('Case', 'Sprawl'))
...
```sh
python script.py Case 30DaysOfPython
```

The result:

```sh
Welcome Case. Enjoy  30DayOfPython challenge! 
```
